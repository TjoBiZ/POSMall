 ...
 */
class SignUp extends POSMallComponent
{
    ...
    {
        return [
            'name'        => 'kodzero.posmall::lang.components.signup.details.name',
            'description' => 'kodzero.posmall::lang.components.signup.details.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'redirect' => [
                'type' => 'string',
                'name' => 'kodzero.posmall::lang.components.signup.properties.redirect.name',
            ],
        ];
    }
    ...
    protected function redirect()
    {
        ...
        if ($redirect = Session::pull('posmall.login.redirect')) {
