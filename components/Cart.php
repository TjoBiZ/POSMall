 ...
 */
class Cart extends POSMallComponent
{
    /**
     * The user's cart.
     *
    ...
    {
        return [
            'name'        => 'kodzero.posmall::lang.components.cart.details.name',
            'description' => 'kodzero.posmall::lang.components.cart.details.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'showDiscountApplier' => [
                'type'    => 'checkbox',
                'title'   => 'kodzero.posmall::lang.components.cart.properties.showDiscountApplier.title',
                'default' => 1,
            ],
            'discountCodeLimit' => [
                'type'    => 'string',
            ...
            'showTaxes'           => [
                'type'    => 'checkbox',
                'title'   => 'kodzero.posmall::lang.components.cart.properties.showTaxes.title',
                'default' => 1,
            ],
            'showShipping' => [
                'type'    => 'checkbox',
                'title'   => 'kodzero.posmall::lang.components.cart.properties.showShipping.title',
                'default' => 1,
            ],
            'showProceedToCheckoutButton' => [
                'type'    => 'checkbox',
                'title'   => 'kodzero.posmall::lang.components.cart.properties.showProceedToCheckoutButton.title',
                'default' => 0,
            ],
        ];
    }
    ...
    public function onUpdateQuantity()
    {
        ...
        try {
            ...
            Flash::error(trans('kodzero.posmall::lang.common.out_of_stock', ['quantity' => $exc->product->stock]));
