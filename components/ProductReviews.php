...
use KodZero\POSMall\Models\ReviewCategory;
...
class ProductReviews extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'kodzero.posmall::lang.components.productReviews.details.name',
            'description' => 'kodzero.posmall::lang.components.productReviews.details.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'perPage'                   => [
                'title' => 'kodzero.posmall::lang.components.productReviews.properties.perPage.title',
                'type'  => 'string',
            ],
    ...
    public function setData()
    {
        ...
        $this->allReviews = Review::with(['category_reviews.review_category', 'variant'])
            ...
            ->get();
        TranslationPreloader::preload($this->allReviews->flatMap->category_reviews->pluck('review_category')->filter());
    ...
    public function onCreate()
    {
        ...
        DB::transaction(function () {
            ...
            $review->customer_id = optional(Customer::forUser(Auth::user()))->id;
