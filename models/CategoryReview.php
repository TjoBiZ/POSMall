...
class CategoryReview extends Model
{
    ...
    public $table = 'kodzero_posmall_category_reviews';

    public $rules = [
        'rating'             => 'bail|required|integer|between:1,5',
        'review_id'          => 'bail|required|integer|exists:kodzero_posmall_reviews,id',
        'review_category_id' => 'bail|nullable|integer|exists:kodzero_posmall_review_categories,id',
    ];
    ...
    {
        $baseQuery = self::whereHas('review', function ($q) use ($target) {
