...
class OrderState extends Model
{
    ...
    public static $availableFlagOptions = [
        self::FLAG_CANCELLED => 'kodzero.posmall::lang.order_states.flags.cancelled',
        self::FLAG_COMPLETE  => 'kodzero.posmall::lang.order_states.flags.complete',
        self::FLAG_NEW       => 'kodzero.posmall::lang.order_states.flags.new',
    ];
     ...
     * @var string
     */
    public $table = 'kodzero_posmall_order_states';
