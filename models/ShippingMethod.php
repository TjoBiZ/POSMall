...
class ShippingMethod extends Model
{
     ...
     * @var string
     */
    public const MORPH_KEY = 'posmall.shipping_method';
     ...
     * additional linking table (`kodzero_posmall_shipping_country`).
     * @var null|string
     */
     ...
     * @var string
     */
    public $table = 'kodzero_posmall_shipping_methods';
    ...
    public $rules = [
        'name'          => 'required',
        'guaranteed_delivery_days' => 'bail|nullable|integer|min:0',
    ...
    public $belongsToMany = [
        ...
        'discounts'     => [
            Discount::class,
            'table'    => 'kodzero_posmall_shipping_method_discount',
            'key'      => 'shipping_method_id',
            'otherKey' => 'discount_id',
        ],
        'countries' => [
            RainLabCountry::class,
            'table'    => 'kodzero_posmall_shipping_countries',
            'key'      => 'shipping_method_id',
            'otherKey' => 'country_id',
        ],
    ];
    ...
    {
        return new self([
            'name'        => trans('kodzero.posmall::lang.shipping_method.not_required_name'),
            'description' => trans('kodzero.posmall::lang.shipping_method.not_required_description'),
        ]);
    }
    ...
    {
        return ShippingMethod::orderBy('sort_order', 'asc')
            ->orderBy('id', 'asc')
            ->first();
    }
    ...
    public static function getAvailability($countryId, $total, $cart = null, $wishlist = null)
    {
        ...
        Event::fire('posmall.shipping.methods.availability', [&$availableShippingMethods, $cart, $wishlist]);
    ...
    {
        $enforcedKey = sprintf('posmall.shipping.enforced.%s.name', $this->id);
    ...
    protected function priceRelation($currency = null, $relation = 'prices', ?Closure $filter = null)
    {
        ...
        $enforcedKey   = sprintf('posmall.shipping.enforced.%s.price', $this->id);
