...
use KodZero\POSMall\Classes\Traits\Category\MenuItems;
use KodZero\POSMall\Classes\Traits\Category\Properties;
use KodZero\POSMall\Classes\Traits\Category\Slug;
use KodZero\POSMall\Classes\Traits\Category\Translation;
...
class Category extends Model
{
     ...
     * @var string
     */
    public const MAP_CACHE_KEY = 'posmall.categories.map';

    /**
     * Cache key to store the category tree.
     * @var string
     */
    public const TREE_CACHE_KEY = 'posmall.categories.tree';
     ...
     * @var string
     */
    public $table = 'kodzero_posmall_categories';
    ...
    public $belongsToMany = [
        ...
        'property_groups'   => [
            PropertyGroup::class,
            'table'    => 'kodzero_posmall_category_property_group',
            'key'      => 'category_id',
    ...
    public static function boot()
    {
        ...
        static::deleted(function (self $model) {
            DB::table('kodzero_posmall_category_product')->where('category_id', $model->id)->delete();
            $model->purgeCache();
            $model->warmCache();
        });
    }
    ...
    public function getParentOptions()
    {
        ...
        return [
            ...
            null => '(' . trans('kodzero.posmall::lang.category.no_parent') . ')',
    ...
    {
        $name    = trans('kodzero.posmall::lang.product.name');
        $created = trans('kodzero.posmall::lang.common.created_at');
