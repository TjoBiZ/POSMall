...
use KodZero\POSMall\Classes\Totals\PaymentTotal;
...
class PaymentMethod extends Model
{
     ...
     * @var string
     */
    public const MORPH_KEY = 'posmall.payment_method';
     ...
     * @var string
     */
    public $table = 'kodzero_posmall_payment_methods';
    ...
    public $rules = [
        ...
        'fee_percentage'    => 'bail|nullable|numeric|min:0',
    ...
    {
        $results = array_filter(Event::fire('posmall.cart.extendAvailablePaymentMethods', [$cart]) ?? []);
    ...
    {
        $null = [null => '-- ' . trans('kodzero.posmall::lang.payment_method.pdf_partial_none')];
        $path = themes_path(sprintf('%s/partials/posmallPDF/*', Theme::getActiveThemeCode()));
