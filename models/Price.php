...
class Price extends Model
{
     ...
     * @var string
     */
    public $table = 'kodzero_posmall_prices';
    ...
    public function isEnabledQuery(Builder $builder)
    {
        if ($this->skipEnabledCheck) {
            ...
            $builder->join(
                'kodzero_posmall_price_categories',
                'kodzero_posmall_prices.price_category_id',
                '=',
                'kodzero_posmall_price_categories.id'
            );
            $builder->where('kodzero_posmall_price_categories.is_enabled', true);
