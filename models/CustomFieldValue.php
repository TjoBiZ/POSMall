...
class CustomFieldValue extends Model
{
    ...
    public $rules = [
        'cart_product_id' => 'exists:kodzero_posmall_cart_products,id',
        'custom_field_id' => 'exists:kodzero_posmall_custom_fields,id',
    ];

    public $table = 'kodzero_posmall_cart_custom_field_value';
    ...
    public function priceForFieldOption(?CustomField $field = null, ?CustomFieldOption $option = null)
    {
        ...
        $option ??= optional($field->custom_field_options)->find($this->custom_field_option_id);
    ...
    public function getDisplayValueAttribute()
    {
        ...
        if ($this->custom_field->type === 'color') {
            ...
            return sprintf(
                ...
                e(CustomFieldOption::sanitizeColorValue((string)$value))
            );
        }
        ...
        if ($this->custom_field->type === 'dropdown') {
            return e($this->custom_field_option->name);
        }
