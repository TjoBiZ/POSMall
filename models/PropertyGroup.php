...
class PropertyGroup extends Model
{
    ...
    public $table = 'kodzero_posmall_property_groups';
    ...
    public $belongsToMany = [
        ...
        'filterable_properties' => [
            ...
            'pivot'      => ['use_for_variants', 'filter_type', 'sort_order'],
            'pivotModel' => PropertyGroupProperty::class,
            'order'      => 'kodzero_posmall_property_property_group.sort_order ASC',
            'conditions' => 'kodzero_posmall_property_property_group.filter_type is not null',
        ],
        'categories'            => [
            Category::class,
