...
namespace KodZero\POSMall\FormWidgets;
...
class Price extends FormWidgetBase
{
    ...
    public function init()
    {
        ...
        $this->addJs('/plugins/kodzero/posmall/assets/pricewidget.js', 'KodZero.POSMall');
        $this->addCss('/plugins/kodzero/posmall/assets/pricewidget.css', 'KodZero.POSMall');
    }
    ...
    public function getSaveValue($value)
    {
        ...
        if (!$values->has($this->defaultCurrency->id)) {
            throw new ValidationException([$this->valueFrom => trans('kodzero.posmall::lang.common.price_missing')]);
        }
