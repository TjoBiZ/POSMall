...
return [
    'plugin' => [
        'name' => 'POSMall',
        'description' => 'PostgreSQL-first eCommerce, POS, услуги и виртуальные товары для October CMS и Laravel',
    ],
    'titles' => [
        'products' => [
    ...
    'payment_gateway_settings' => [
        ...
        'stripe' => [
            ...
            'api_key_comment' => 'Используйте Secret key из Stripe Dashboard. Он хранится зашифрованным и не должен попадать в браузер.',
            'publishable_key' => 'Stripe публичный ключ',
            'publishable_key_comment' => 'Используйте Publishable key из Stripe Dashboard.',
        ],
        'paypal' => [
    ...
    'general_settings' => [
        ...
        'order_notification_email' => 'Почта уведомлений о заказах',
        'order_notification_email_comment' => 'Уведомления о заказах отправляются на этот адрес. Если поле пустое, используется почта администратора.',
        'send_order_notification_to_customer' => 'Отправлять уведомление о заказе клиенту',
        'send_order_notification_to_customer_comment' => 'Оставьте включенным, чтобы отправлять клиенту checkout/order письма, когда соответствующее уведомление включено.',
        'storefront_assets_optimized' => 'Использовать оптимизированные storefront assets',
        'storefront_assets_optimized_comment' => 'Когда включено, POSMall использует CSS/JS, собранные и минифицированные Laravel Mix из manifest темы POSMall. Minification/PurgeCSS могут сломать динамические классы, если entry-файлы неполные; импортируйте storefront-код через themes/kodzero-posmalltheme/assets/src entry-файлы и пересобирайте PageSpeed assets после изменений.',
        ...
        'index_driver_comment' => 'В этой PostgreSQL-ветке индекс товаров всегда использует PostgreSQL. Legacy-драйверы оставлены в коде только для rollback/reference.',
        'index_driver_filesystem' => 'Файловая система (deprecated в этой ветке)',
        'index_driver_database' => 'База данных (PostgreSQL в этой ветке)',
        'index_driver_hint' => 'Если вы измените этот параметр, обязательно запустите :command в командной строке, чтобы переиндексировать ваши товары!',
    ],
    'feed_settings' => [
    ...
    'common' => [
        ...
        'slug_unique' => 'URL Slug должен быть уникальным',
        'fees' => 'Сборы',
        'value' => 'Значение',
    ...
    'product' => [
        ...
        'embed_code' => 'YouTube URL или embed-код',
        'embed_code_comment' => 'Вставьте YouTube URL, YouTube embed URL, video ID или прежний embed-код. На витрине используется только извлеченный YouTube video ID.',
        'properties' => 'Свойства',
        'links' => 'Ссылки',
        'embeds' => 'Вставки',
        'details' => 'Детали',
        ...
        'no_property_groups_title' => 'Для категории нет доступных свойств',
        'no_property_groups_comment' => 'Свойства товаров настраиваются в разделе Каталог > Свойства и становятся доступными для редактирования после привязки группы свойств к одной из категорий товара.',
        'configure_properties_link' => 'Открыть Каталог > Свойства',
    ...
    'tax' => [
        ...
        'states' => 'Применять налог только при доставке в эти штаты / регионы',
        'states_comment' => 'Если штат не выбран, налог не ограничен штатом.',
        'is_default' => 'По умолчанию',
    ...
    'components' => [
        ...
        'productSearch' => [
            'details' => [
                'name' => 'Поиск товаров',
                'description' => 'Показывает подсказки и результаты поиска товаров POSMall',
            ],
            'properties' => [
                'mode' => [
                    'name' => 'Режим',
    ...
    'services' => [
        ...
        'gallery_autoplay_seconds' => 'Интервал автоперелистывания',
        'gallery_autoplay_seconds_comment' => 'Секунды между автоматической сменой изображений. Можно использовать десятичные значения, например 1.3. Диапазон: от 0.5 до 30 секунд.',
    ],
    'reviews' => [
        'rating' => 'Рейтинг',
