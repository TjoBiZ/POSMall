...
return [
    'plugin' => [
        'name' => 'POSMall',
        'description' => 'PostgreSQL-first eCommerce, POS, services and virtual products for October CMS and Laravel',
    ],
    'titles' => [
        'products' => [
    ...
    'menu_items' => [
        ...
        'single_product' => 'Single shop product',
        'single_variant' => 'Single shop variant',
    ...
    'payment_gateway_settings' => [
        ...
        'stripe' => [
            ...
            'api_key_comment' => 'Use the Secret key from your Stripe Dashboard. It is stored encrypted and must never be exposed in the browser.',
            'publishable_key' => 'Stripe Publishable Key',
            'publishable_key_comment' => 'Use the Publishable key from your Stripe Dashboard.',
    ...
    'general_settings' => [
        'category' => 'POSMall: General',
        'category_payments' => 'POSMall: Payments',
        'category_orders' => 'POSMall: Orders',
        'label' => 'Configuration',
        ...
        'order_notification_email_comment' => 'Order notifications are sent here. Falls back to Admin email when empty.',
        'send_order_notification_to_customer' => 'Send order notification to customer',
        'send_order_notification_to_customer_comment' => 'Keep enabled to send checkout/order emails to the customer when the matching notification is enabled.',
        'storefront_assets_optimized' => 'Use optimized storefront assets',
        'storefront_assets_optimized_comment' => 'When enabled, POSMall uses Laravel Mix compiled/minified CSS/JS from the POSMall theme manifest. Minification/PurgeCSS can break dynamic classes if entry files are incomplete; import storefront code through themes/kodzero-posmalltheme/assets/src entry files and rebuild PageSpeed assets after changes.',
        'base' => 'Base settings',
        'links' => 'CMS pages',
        ...
        'index_driver_comment' => 'On this PostgreSQL branch, the product index always uses PostgreSQL. Legacy drivers remain in code for rollback/reference only.',
        'index_driver_filesystem' => 'Filesystem (deprecated on this branch)',
        'index_driver_database' => 'Database (PostgreSQL on this branch)',
    ...
    'common' => [
        ...
        'api_error' => 'Could not save discount. Error while sending changes to the POSMall API.',
        ...
        'slug_unique' => 'The URL Slug has to be unique',
        'fees' => 'Fees',
        'value' => 'Value',
    ...
    'product' => [
        ...
        'embed_title' => 'Title',
        'embed_code' => 'YouTube URL or embed code',
        'embed_code_comment' => 'Paste a YouTube URL, YouTube embed URL, video ID, or the previous embed code. Storefront playback uses only the extracted YouTube video ID.',
        'properties' => 'Properties',
        'links' => 'Links',
        'embeds' => 'Embeds',
        'details' => 'Details',
        ...
        'no_property_groups_title' => 'No category properties are available',
        'no_property_groups_comment' => 'Product properties are defined under Catalogue > Properties and become editable after a property group is assigned to one of this product\'s categories.',
        'configure_properties_link' => 'Open Catalogue > Properties',
    ...
    'tax' => [
        ...
        'states' => 'Only apply tax when shipping to these states / regions',
        'states_comment' => 'If no state is selected, the tax is not restricted by state.',
        'is_default' => 'Default',
    ...
    'components' => [
        ...
        'productSearch' => [
            'details' => [
                'name' => 'Product search',
                'description' => 'Shows POSMall product search suggestions and results',
            ],
            'properties' => [
                'mode' => [
                    'name' => 'Mode',
    ...
    'services' => [
        ...
        'gallery_autoplay_seconds' => 'Autoplay interval',
        'gallery_autoplay_seconds_comment' => 'Seconds between automatic image changes. Use decimals such as 1.3. Allowed range: 0.5 to 30 seconds.',
    ],
    'reviews' => [
        'rating' => 'Rating',
