...
return [
    'plugin' => [
        'name' => 'POSMall',
        'description' => 'PostgreSQL-first E-Commerce-Backend für October CMS',
    ],
    'titles' => [
        'products' => [
    ...
    'general_settings' => [
        'category' => 'POSMall: Allgemein',
        'category_payments' => 'POSMall: Zahlungen',
        'category_orders' => 'POSMall: Bestellungen',
        ...
        'index_driver_database' => 'Datenbank (PostgreSQL)',
