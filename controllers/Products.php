...
use KodZero\POSMall\Classes\Traits\ProductPriceTable;
...
class Products extends Controller
{
    ...
    public $requiredPermissions = [
        'kodzero.posmall.manage_products',
    ];
    ...
    {
        parent::__construct();
        BackendMenu::setContext('KodZero.POSMall', 'posmall-catalogue', 'posmall-products');

        $model                  = post('option_id') ? CustomFieldOption::find(post('option_id')) : null;
        $this->optionFormWidget = $this->createOptionFormWidget($model);
        $this->addCss('/plugins/kodzero/posmall/assets/backend.css');
        ...
        if (count($this->params) > 0) {
            ...
            session()->flash('posmall.variants.disable-inheritance');
    ...
    public function update($id)
    {
        ...
        if (!$this->vars['formModel']->categories) {
            Flash::error(trans('kodzero.posmall::lang.common.action_required'));

            return redirect(Backend::url('kodzero/posmall/products/change_category/' . $id));
        }
    ...
    {
        $this->pageTitle   = trans('kodzero.posmall::lang.common.action_required');
        $config            = $this->makeConfigFromArray([
            'fields' => [
                'categories' => [
                    'label'           => 'kodzero.posmall::lang.common.category',
                    'nameFrom'        => 'name',
    ...
    public function change_category_onSave()
    {
        ...
        return redirect(Backend::url('kodzero/posmall/products/update/' . $this->params[0]));
    }
    ...
    public function formAfterCreate(Product $model)
    {
        ...
        if ($model->initial_images->count() > 0) {
            ...
            app(CatalogImageOptimizer::class)->optimizeImageSet((int)$imageSet->id);
        }
    }
    ...
    public function onApproveReview()
    {
        ...
        Flash::success(trans('kodzero.posmall::lang.reviews.approved'));
    ...
    public function onLoadCreateOptionForm()
    {
        ...
        return $this->makePartial('$/kodzero/posmall/controllers/customfields/_option_form.htm');
    }
    ...
    public function onDuplicateProducts()
    {
        ...
        Flash::success(trans('kodzero.posmall::lang.common.duplicated'));
    ...
    protected function refreshOptionsList()
    {
        ...
        return ['#optionList' => $this->makePartial('$/kodzero/posmall/controllers/customfields/_options_list.htm')];
    }
    ...
    {
        $config                    = $this->makeConfig('$/kodzero/posmall/models/customfieldoption/fields.yaml');
    ...
    protected function createImageSetFromTempImages(Variant $variant)
    {
        ...
        if ($tempImages < 1) {
            ...
            return DB::transaction(function () use ($variant) {
                ...
                app(CatalogImageOptimizer::class)->optimizeImageSet((int)$set->id);
