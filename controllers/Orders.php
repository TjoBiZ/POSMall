...
use KodZero\POSMall\Classes\Stats\OrdersStats;
...
class Orders extends Controller
{
    ...
    {
        parent::__construct();
        BackendMenu::setContext('KodZero.POSMall', 'posmall-orders', 'posmall-orders');
    }
    ...
    public function show()
    {
        ...
        $this->pageTitle = trans('kodzero.posmall::lang.titles.orders.show');
        $this->addCss('/plugins/kodzero/posmall/assets/backend.css');
        $this->vars['ordersList'] = Backend::url('kodzero/posmall/orders');
        $this->vars['productUpdate'] = Backend::url('kodzero/posmall/products/update');
        $this->vars['addressUpdate'] = Backend::url('kodzero/posmall/addresses/update');
        ...
        $config = $this->makeConfigFromArray([
            'fields' => [
                'customer_notes' => [
                    'label' => 'kodzero.posmall::lang.order.customer_notes',
                    'span' => 'full',
                    'type' => 'textarea',
                    'size' => 'tiny',
                ],
                'admin_notes' => [
                    'label' => 'kodzero.posmall::lang.order.admin_notes',
                    'comment' => 'kodzero.posmall::lang.order.admin_notes_comment',
                    'span' => 'full',
                    'type' => 'textarea',
                    'size' => 'tiny',
                ],
    ...
    public function onUpdateNotes()
    {
        ...
        Flash::success(trans('kodzero.posmall::lang.order.notes_updated'));
    }
    ...
    public function onChangePaymentState()
    {
        ...
        if (!in_array($newState, $availableStatus)) {
            throw new ValidationException([trans('kodzero.posmall::lang.order.invalid_status')]);
        }
    ...
    public function onDelete($recordId = null)
    {
        ...
        $order->delete();
        Flash::success(trans('kodzero.posmall::lang.order.deleted'));

        return Backend::redirect('kodzero/posmall/orders');
    }
    ...
    protected function updateOrder(array $attributes, bool $stateNotification = true, bool $shippingNotification = false)
    {
        ...
        $order->save();
        Flash::success(trans('kodzero.posmall::lang.order.updated'));
