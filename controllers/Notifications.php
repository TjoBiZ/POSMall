...
class Notifications extends Controller
{
    ...
    public $requiredPermissions = [
        'kodzero.posmall.manage_notifications',
    ];
    ...
    public function __construct()
    {
        ...
        SettingsManager::setContext('KodZero.POSMall', 'notification_settings');
    }
    ...
    public function onToggleClicked()
    {
        ...
        Flash::success(trans('backend::lang.form.update_success', [
            'name' => trans('kodzero.posmall::lang.common.notification'),
        ]));
    }
}
