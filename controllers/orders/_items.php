...
<table class="table data">
    ...
    <tr>
        <th>
            <span>
                <?= e(trans('kodzero.posmall::lang.product.name')) ?>
            </span>
        </th>
        <th class="text-right">
            <span>
                <?= e(trans('kodzero.posmall::lang.order.quantity')) ?>
            </span>
        </th>
        <th class="text-right">
            <span>
                <?= e(trans('kodzero.posmall::lang.product.price')) ?>
            </span>
        </th>
        <th class="text-right">
            <span>
                <?= e(trans('kodzero.posmall::lang.order.total')) ?>
            </span>
        </th>
    </tr>
    </thead>
    ...
    <tr>
        <td>
            <?= $this->fireViewEvent('posmall.backend.orders.extendItemDetails', [$item, $order]); ?>
            ...
            <?php if ($item->service_options): ?>
                <?php foreach ($item->service_options as $option): ?>
                    <strong><?= e(trans('kodzero.posmall::lang.common.service')) ?></strong>:
                    <?= e($option['name']) ?><br/>
                <?php endforeach; ?>
            <?php endif; ?>
        </td>
    ...
    <tr class="orderfooter separator separator-bottom">
        <td colspan="3">
            <span>
                <?= e(trans('kodzero.posmall::lang.order.subtotal')) ?>
            </span>
        </td>
        <td class="text-right">
            <span>
    ...
    <tr class="orderdiscount">
        <td colspan="3">
            <span>
                <?= e(trans('kodzero.posmall::lang.common.discount')) ?>:
    ...
    <tr class="orderfooter separator">
        <td colspan="3">
            <span>
                <?= e(trans('kodzero.posmall::lang.common.shipping')) ?>:
    ...
    <tr class="orderfooter separator">
        <td colspan="3">
            <span>
                <?= e(trans('kodzero.posmall::lang.common.payment')) ?>:
        ...
        <td class="text-right">
            <span>
                <?php $currency = KodZero\POSMall\Models\Currency::find(array_get($order->currency, 'id', 0)); ?>
    ...
    <tr class="orderfooter-bottomline">
        <td colspan="3">
            <span>
                <?= e(trans('kodzero.posmall::lang.order.grand_total')) ?>
            </span>
        </td>
