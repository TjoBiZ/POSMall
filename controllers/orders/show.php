        ...
        <div class="layout">
            <div class="control-breadcrumb breadcrumb-flush">
                <ul>
                    <li>
                        <a href="<?= $ordersList ?>">
                            <?= e(trans('kodzero.posmall::lang.common.orders')) ?>
                        </a>
                    </li>
                        ...
                        <div class="layout-row">
                            ...
                            <div class="control-tabs primary-tabs" data-control="tab">
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#order">
                                            <?= e(trans('kodzero.posmall::lang.common.products')) ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#payments">
                                            <?= e(trans('kodzero.posmall::lang.common.payments')) ?>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="form-buttons">
                            <div class="loading-indicator-container">
                                <button
                                    ...
                                    data-load-indicator="<?= e(trans('kodzero.posmall::lang.order.deleting')) ?>"
                                    data-request-confirm="<?= e(trans('kodzero.posmall::lang.order.delete_confirm')) ?>"
                                >
                                </button>
                            </div>
                        </div>
            ...
            <div class="layout-absolute">
                <div class="sidebar-content">
                    <?= $this->makePartial('address', [
                        ...
                        'heading' => e(trans('kodzero.posmall::lang.order.shipping_address')),
                    ]) ?>

                    <?php if (!$order['shipping_address_same_as_billing']): ?>
                        <?= $this->makePartial('address', [
                            'address' => $order['billing_address'],
                            'heading' => e(trans('kodzero.posmall::lang.order.billing_address')),
                        ]) ?>
                    <?php else: ?>
                        <div class="sidebar-box sidebar-box--with-icon">
                            <i class="icon icon-info-circle"></i>
                            <?= e(trans('kodzero.posmall::lang.order.shipping_address_is_same_as_billing')); ?>
                        </div>
                    <?php endif; ?>

                    <?php
                    $customOutputs = Event::fire('posmall.backend.order.sidebar', [$order]);
                    ...
                    <?php if (config('kodzero.posmall::features.order_notes')): ?>

                        <h5><?= e(trans('kodzero.posmall::lang.order.notes_section')) ?></h5>
                        ...
                        <form action="#" data-request="onUpdateNotes" data-request-validate data-request-flash>
                            ...
                            <button data-attach-loading class="btn btn-primary w-100">
                                <?= e(trans('kodzero.posmall::lang.order.update_notes')) ?>
                            </button>
                        </form>
