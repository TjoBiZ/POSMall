...
namespace KodZero\POSMall\Classes\CategoryFilter\SortOrder;
...
abstract class SortOrder implements CallsAnyMethod
{
    ...
    public static function options($excludeInternal = false)
    {
        ...
        $extensions = array_filter(Event::fire('kodzero.posmall.extendSortOrder'));
    ...
    {
        return trans('kodzero.posmall::lang.components.productsFilter.sortOrder.' . camel_case($this->key()));
    }
