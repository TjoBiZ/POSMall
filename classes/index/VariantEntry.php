...
class VariantEntry implements Entry
{
    ...
    public function __construct(Variant $variant)
    {
        ...
        $result = Event::fire('posmall.index.extendVariant', [$product, $variant]);
    ...
    {
        return $variant->withForcedPriceInheritance(fn () => Currency::getAll()->mapWithKeys(fn ($currency) => [$currency->code => $variant->price($currency)->integer]));
    }
