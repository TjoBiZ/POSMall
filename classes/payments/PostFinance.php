...
class PostFinance extends PaymentProvider
{
    ...
    public function settings(): array
    {
        return [
            'postfinance_test_mode'      => [
                'label'   => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.test_mode',
                'comment' => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.test_mode_comment',
                'span'    => 'left',
                'type'    => 'switch',
            ],
            'postfinance_pspid'          => [
                'label' => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.pspid',
                'span'  => 'left',
                'type'  => 'text',
            ],
            'postfinance_hashing_method' => [
                'label'   => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.hashing_method',
                'comment' => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.hashing_method_comment',
                'default' => 'sha1',
                'span'    => 'left',
                'type'    => 'dropdown',
                'options' => [
            ...
            'postfinance_sha_in'         => [
                'label'   => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.sha_in',
                'comment' => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.sha_in_comment',
                'span'    => 'left',
                'type'    => 'text',
            ],
            'postfinance_sha_out'        => [
                'label'   => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.sha_out',
                'comment' => 'kodzero.posmall::lang.payment_gateway_settings.postfinance.sha_out_comment',
                'span'    => 'left',
                'type'    => 'text',
            ],
        ];
    ...
    protected function getGateway()
    {
        ...
        $gateway->initialize([
            'pspId'         => PaymentGatewaySettings::secret('postfinance_pspid'),
            'shaIn'         => PaymentGatewaySettings::secret('postfinance_sha_in'),
            'shaOut'        => PaymentGatewaySettings::secret('postfinance_sha_out'),
